...
--A:
-- 1) Create a CTE to calculate the total sales grouped by market dates:
...
-- 2) Create another CTE with a rank window function:
ranked_sales AS (
  SELECT
...
-- 3) Query the second CTE twice and UNION them:
SELECT
  market_date, total_sales,
